...
import { FluidSimulation } from '@site/bgModules/advanced/FluidSimulation'
import type { ModuleSetupParams } from '@site/contexts/BackgroundContext'
...
describe('FluidSimulation', () => {
  ...
  describe('Module Setup', () => {
    ...
    it('should handle shader compilation errors', () => {
      ...
      mockWebGLContext.getShaderInfoLog = vi.fn(() => 'Shader error')
    ...
    it('should handle program linking errors', () => {
      ...
      mockWebGLContext.getProgramInfoLog = vi.fn(() => 'Program error')
